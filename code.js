...
exports.handler = function(event, context, callback) {
    ...
    alexa.appId = appId;
    alexa.dynamoDBTableName = 'creditcardinfo';
    alexa.registerHandlers(newSessionHandlers, deliverInfoModeHandlers, registerInfoModeHandlers, registerInfoModeTwoHandlers, registerInfoModeThreeHandlers, registerInfoModeFourHandlers);
    alexa.execute();
};
...
var deliverInfoModeHandlers = Alexa.CreateStateHandler(states.DELMODE, {
    ...
    'DELFIRST': function() {
        ...
        var firstfour = parseInt(this.event.request.intent.slots.delfirstn.value);
        var num = this.attributes["firstfour"];
        this.emit(':tell', 'Your card number is:' +  num.to_string());
    },
...
var registerInfoModeHandlers = Alexa.CreateStateHandler(states.REGMODE, {
    ...
    'FIRST': function() {
        ...
        first = parseInt(this.event.request.intent.slots.firstn.value);
        this.attributes[first.to_string()] = first.to_string();
...
var registerInfoModeTwoHandlers = Alexa.CreateStateHandler(states.REGMODETWO, {
    ...
    'SECOND': function() {
        ...
        var second = parseInt(this.event.request.intent.slots.secondn.value);
        this.attributes[first.to_string()] = this.attributes[first.to_string()] + second.to_string();
        // Change state for next 4 digits
...
var registerInfoModeThreeHandlers = Alexa.CreateStateHandler(states.REGMODETHREE, {
    ...
    'THIRD': function() {
        ...
        var third = parseInt(this.event.request.intent.slots.thirdn.value);
        this.attributes[first.to_string()] = this.attributes[first.to_string()] + third.to_string();
        // Change state for next 4 digits
...
var registerInfoModeFourHandlers = Alexa.CreateStateHandler(states.REGMODEFOUR, {
    ...
    'FOURTH': function() {
        ...
        var fourth = parseInt(this.event.request.intent.slots.fourthn.value);
        this.attributes[first.to_string()] = this.attributes[first.to_string()] + fourth.to_string();
        // Save all digits
